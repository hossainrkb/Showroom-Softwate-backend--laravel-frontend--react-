...
class Installment_Report extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        axios
            .get("http://127.0.0.1:8000/api/saleType/installment/report")
            .then(res => {
                this.setState({
                    installment_report: res.data
                });
            })
            .catch(error => {
                console.log(error);
                        ...
                        <div className="col-md-12">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <ReactTable
                                        columns={columns}
                                        data={this.state.installment_report}
                                        defaultPageSize={5}
...
export default Installment_Report;
