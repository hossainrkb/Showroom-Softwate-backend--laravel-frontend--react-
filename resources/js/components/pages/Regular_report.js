...
class Regular_Report extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        axios
            .get("http://127.0.0.1:8000/api/saleType/regular/report")
            .then(res => {
                this.setState({
                    regular_report: res.data
                });
            })
            .catch(error => {
                console.log(error);
                        ...
                        <div className="col-md-12">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <ReactTable
                                        columns={columns}
                                        data={this.state.regular_report}
                                        defaultPageSize={5}
