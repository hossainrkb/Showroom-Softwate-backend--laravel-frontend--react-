...
class Invoice_discount extends Component {
    constructor(props) {
        super(props);
    ...
    holaOnSubmit(e) {
        ...
        axios
            ...
            .then(response => {
                this.setState({
                    discount_success: response.data
                });
                //again call
                axios
                    .get(
            ...
            <div id="content">
                ...
                <div className="row">
                    <div className="col-md-12">
                        <h2>
                            <i className="fas fa-minus-square"></i> PUT DISCOUNT{" "}
                            {this.props.match.params.invoice_id}
                        </h2>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-12">
                        <div className="card">
                            ...
                            >
                                <h3>Enter Discount Information Below</h3>
                                {this.state.discount_success && (
                                    <p
                                        style={{ color: "white" }}
                                    ...
                                    >
                                        {this.state.discount_success}{" "}
                                        <NavLink
                                            className="btn badge btn-danger ml-2"
                                            to={`/invoice/${this.state.my_invo.in_o_code}`}
                                        >
                                            <i className="fa fa-plus"></i> Check
                                            invoice
                                        </NavLink>
                                    </p>
                                )}
...
export default Invoice_discount;
